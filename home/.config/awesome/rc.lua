...
local tasklist_buttons = gears.table.join(
  awful.button({}, 1, function(c)
    if c == client.focus then
      ...
      c:emit_signal('request::activate', 'tasklist', { raise = true, switchtotag = true })
    end
  end),
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, 'a', awful.tag.history.restore, { description = 'go back to previous tag', group = 'tag' }),
  ...
  awful.key({ modkey, 'Shift' }, 'e', function()
    awful.spawn(terminal .. ' -o font.size=50 -e tmux')
  end, { description = 'open a terminal', group = 'launcher' }),
  ...
  awful.key({ modkey, 'Tab' }, 'Delete', function()
    awful.spawn('systemctl hibernate')
  end, { description = 'hibernate', group = 'awesome' }),
  ...
  end, { description = 'move all to other screen', group = 'client' }),

  awful.key({ modkey, 'Shift' }, 'i', function()
    require('apps')()
  end, { description = 'start default applications', group = 'launcher' }),
  ...
  end, { description = 'show password manager', group = 'launcher' }),
  -- Bookmarks
  awful.key({ modkey }, 'g', function()
    awful.spawn('bm -r')
  end, { description = 'show bookmarks', group = 'launcher' }),
  -- Screenshot
  ...
  end, { description = 'set us layout', group = 'misc' }),
  awful.key({ modkey, 'Shift' }, 'b', function()
    awful.spawn.with_shell('setxkbmap lt')
  end, { description = 'set lt layout', group = 'misc' }),
